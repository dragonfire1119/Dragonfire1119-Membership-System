 ...
 * 
 * The cookie path is / if your url has no directorys http://dragonfire1119.com/
 * or if your url is like http://dragonfire1119.com/example/
 * Make it /example/ as the cookie path
 */
define("COOKIE_EXPIRE", 60*60*24*100);  //100 days by default
define("COOKIE_PATH", "/new-dms/");  //Avaible in whole domain
...
/**
 * Please do not change this if you are going to delete this please donate to my development of DMS I take allot of time 
 * to make this
 */
// DO NOT EDIT
