...
class Zebra_Form_Control extends XSS_Clean
{
     ...
     *      if (
     *
     *          // i run functions depending on what's in the $_POST
     *          (isset($_POST['username']) && username_not_taken($_POST['username'])) ||
     *          (isset($_POST['email']) && emailaddress_not_taken($_POST['email']))
     *
                ...
                switch ($rule_name) {
                    ...
                    case 'length':
                        ...
                        if ($rule_properties[1] > 0) {
                            ...
                            // and the first argument is [0] meaning that there's no lower limit
                            if (isset($rule_properties[4]) && $rule_properties[4] === true && (int)$rule_properties[0] == 0) {
